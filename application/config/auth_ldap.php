...
$config['basedn'] = 'OU=PEOPLE,DC=ad,DC=uniandes,DC=edu,DC=co';
$config['login_attribute'] = 'cn';
$config['use_ad'] = false;
$config['ad_domain'] = '';
$config['proxy_user'] = 'CN=SvcP-Sop4-Adm,OU=Service Accounts,DC=ad,DC=uniandes,DC=edu,DC=co';
$config['proxy_pass'] = '620EQ6J7sI';
