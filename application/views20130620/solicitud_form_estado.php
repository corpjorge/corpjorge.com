...
<div style="text-align:center">
	...
	<a href="<?php echo base_url()?>index.php/solicitud/ver/<?php echo $sol_id; ?>">Ver Solicitud</a>	
        <br>
	<a href="<?php echo base_url()?>index.php/solicitud/formaestado/<?php echo $sol_id_anterior; ?>">Anterior</a> |
        <a href="<?php echo base_url()?>index.php/solicitud/formaestado/<?php echo $sol_id_siguiente; ?>">Siguiente</a><br>
</div>
<?php } ?>
