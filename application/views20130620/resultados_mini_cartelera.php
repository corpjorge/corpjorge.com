...
<div id="minicartelera">
    ...
    <table width="100%" border="0" cellspacing="10" cellpadding="0">
        ...
        foreach ($registros as $registro) {
            echo "<tr><td class='th'><input type=\"radio\" name=\"sec\" onclick=\"enviar(".$registro["CRN"].",'".$registro["TITULO"]."','".$registro["tipo"]."','".@$registro["key2"]."','".@$registro["seccion2"]."','".@$registro["MATERIA"]."','".@$registro["PROFESORES"]."','".$registro['SECCION']."','".@$registro['materias2']."','".@$registro['las_secciones2']."','".@$registro['profesores2']."')\" value='".$registro["CRN"]."'></td>";
