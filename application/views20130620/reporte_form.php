	...
	<div id="filtros">
		<table class='formtable' cellspacing="0" cellpadding="0" border="0" width="100%">
			<tr>
				<td colspan="2" align="center">
					<table class='formtable'>
						<tr>
							<td colspan="6" align="center"><label style="font-size:14pt;font-weight:bold">Seleccione el tipo de reporte</label></td>
						</tr>
						<tr>				
							<td>
			...
			<tr>				
				...
				<td><br>
				<?php echo form_input('fecha_ini','',' id="fecha_ini" placeholder="Fecha inicial" class="datetime" readonly="readonly"'); ?></td>				
			</tr>
			<tr>				
