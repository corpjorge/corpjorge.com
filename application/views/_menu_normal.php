...
<div class="menu-principal" style="display:block">
        ...
        <span class="lb"></span>
            <ul class="menu">
                ...
                <li class="level2 item129"><a href="<?php echo base_url();?>index.php/mensajes"><span>Gesti&oacute;n de mensajes</span></a></li>
                <li class="level2 item129"><a href="<?php echo base_url();?>index.php/reporte/"><span>Reportes</span></a></li>
				<li class="level2 item129"><a href="<?php echo base_url();?>index.php/comentarios"><span>Gesti&oacute;n de comentarios</span></a></li>

				<?php if(@$bloqueo_crn=="1"){ ?>
