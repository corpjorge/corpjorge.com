...
?>
	...
	<tr>
	    <td class="tdlabel">Permitir bloqueo CRN:</td>
	    <td>
			<select name="sol_creacion" id="sol_creacion">
				<option value="1" <?php echo $sol_creacion=="1" ? "selected" : ""; ?>>Si</option>
				<option value="0" <?php echo $sol_creacion=="0" ? "selected" : ""; ?>>No</option>
			</select>
		</td>
	</tr>
	<tr>
