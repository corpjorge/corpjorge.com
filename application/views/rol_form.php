...
?>
<a  class="volver" href="<?php echo base_url()?>index.php/rol/">Volver</a><br>
...
<?php echo form_open('rol/'.$accion.'/'.$rol_id); ?>

	<h1><?php echo $titulo; ?> rol</h1>
	<p>
		<label for="email">Descripci&oacute;n: </label>
		<?php echo form_input('descripcion', set_value('descripcion', $rol_descripcion)); ?>
