...
<div id="listado">
	...
	<a href="<?php echo base_url();?>index.php/comentarios">Gesti&oacute;n de comentarios</a><br>
	<a href="<?php echo base_url();?>index.php/mensajes">Gesti&oacute;n de mensajes</a><br>
