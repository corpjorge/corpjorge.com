...
function enviar_cancelados(){
	...
	var r = confirm("Nota: Recuerde que las solicitudes en estado exitoso y no exitoso no podrán ser canceladas.\n\nConfirme que desea continuar con el proceso.");
		if (r != true) {
			return false;
		} 
...
<div style="text-align:center">
	<a href="<?php echo base_url()?>index.php/solicitud/formacancelar/<?php echo $sol_id_anterior; ?>">Anterior</a> | <a href="<?php echo base_url()?>index.php/solicitud/formacancelar/<?php echo $sol_id_siguiente; ?>">Siguiente</a><br>
</div>
<?php } ?>
...
<?php if($tipo=='uno'){?>
	...
	<?php } ?>	
	<?php if(!empty($ids_habilitados)){?>
	 <form name='cancelaform' id='cancelaform' action='<?php echo base_url()?>index.php/solicitud/cancelar' method='POST'>
	<table id='comentario_nuevo' class='formtable'>		
		...
		<tr>
			<td>
				<input type='button' value='Enviar' onclick='enviar_cancelados()'><?php echo form_hidden('sol_id', $ids_habilitados);?>
			</td>
			<td>
	...
	<table id='comentario_nuevo' class='formtable'>
	<tr>		
	 <td class="tdlabel">Ninguna de las solicitudes elegidas puede ser cancelada</td>
	</tr>
	</table>
	 </form>
	<?php }?>
