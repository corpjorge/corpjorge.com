...
?>
	...
	<tr>
		<td class="tdlabel"><b>Primer Semestre :</b></td>
		<td><b><?php echo $sol_primer_semes_msg;?></b></td>
	</tr>
	<tr>
	...
	if(@$sol_sug_crns_cc!='') { ?>
	<tr id='crn_com_2' >
		<td class="tdlabel">CRN Correquisito:</td>
		<td><?php echo @$sol_sug_crns_cc; ?></td>
	</tr>
	<? } ?>
	<? if(@$sol_sug_crns_cc_materia!='') { ?>
	<tr>
		<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;C&oacute;digo: </td>
		<td><?php echo  @$sol_sug_crns_cc_materia;?></td>
	</tr>
	<? } ?>
	<? if(@$sol_sug_crns_cc_seccion!='') { ?>
	<tr>
		<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Secci&oacute;n: </td>
		<td><?php echo  @$sol_sug_crns_cc_seccion;?></td>
	</tr>
	<? } ?>
	<? if(@$sol_sug_crns_cc_instructor!='') { ?>
	<tr>
		<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Instructor: </td>
		<td><?php echo  @$sol_sug_crns_cc_instructor;?></td>
	</tr>
	<tr>
		<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Tipo: </td>
		<td>CORREQUISITO</td>
	...
	<? } ?>
	<? if(@$sol_sug_crns_cc_cupos!='') { ?>
	<tr>
		<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Cupos: </td>
		<td><?php echo  @$sol_sug_crns_cc_cupos;?></td>
	</tr>
	<tr>
		<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Inscritos: </td>
		<td><?php echo  @$sol_sug_crns_cc_cupos_ins;?></td>
	</tr>
	<? } ?>
	...
	if (isset($alternativas))
	{
		...
		<tr >
			<td colspan="2" class="tdlabel">Alternativas</td>
		</tr>
		...
		foreach ($alternativas as $alternativa) {
			...
			<tr>
				...
				<td><?php echo  @$alternativa['crn'];?></td>
			</tr>
			<tr>
				<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Secci&oacute;n: </td>
				<td><?php echo  @$alternativa['secciones'];?></td>
			</tr>
			<tr>
				<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Instructor: </td>
				<td><?php echo  @$alternativa['instructor'];?></td>
			</tr>
			<tr>
				<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Cupos: </td>
				<td><?php echo  @$alternativa['sol_ret_cupos'];?></td>
			</tr>
			<tr>
				<td class="tdlabel">&nbsp;&nbsp;&nbsp;&nbsp;Inscritos: </td>
				<td><?php echo  @$alternativa['sol_ret_cupos_ins'];?></td>
			</tr>
			<?php 	}
		}
		?>
