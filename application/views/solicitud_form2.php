...
function get_minicartelera(tip_id, id/*campo*/, valor, tipo, pidm){
	...
	window.open("<?php echo base_url();?>/index.php/solicitud/ayudaMinicartelera/"+ tip_id + '/' + id + '/' + valor + '/' + tipo + '/' + pidm,"",opciones);
}
...
function put_crn(id,seccion, tipo, id_input, id2, seccion2, materia, instructor, la_seccion, materia2, la_seccion2, instructor2){ //los datos de la magistral id2 y seccion2 son opcionales
	//alert('put_crn ' + id + ' ' + seccion + ' ' + tipo + ' ' + id_input + '---id2--- ' + id2 + ' ' + seccion2); 
...
<table class='formtable' width="100%" id='crn_disp_2' style='display:none'>
	...
	<tr>
		...
		<td>
			...
			echo form_input('sol_disp_crn_ins', set_value('sol_disp_crn_ins', @$sol_disp_crn_ins));
			$id=' id="sol_disp_crn_ins_tipo"';
			echo form_input('sol_disp_crn_ins_tipo', set_value('sol_disp_crn_ins_tipo', @$sol_disp_crn_ins_tipo));
			$id=' id="sol_disp_crn_ins_materia"';
			echo form_input('sol_disp_crn_ins_materia', set_value('sol_disp_crn_ins_materia', @$sol_disp_crn_ins_materia));
			$id=' id="sol_disp_crn_ins_instructor"';
			echo '<br>Instructor'.form_input('sol_disp_crn_ins_instructor', set_value('sol_disp_crn_ins_instructor', @$sol_disp_crn_ins_instructor));
			$id=' id="sol_disp_crn_ins_seccion"';
			echo form_input('sol_disp_crn_ins_seccion', set_value('sol_disp_crn_ins_seccion', @$sol_disp_crn_ins_seccion));
			?>		
		</td>
	</tr>
	<tr>
...
<table class='formtable' width="100%" id='crn_disp_1' style='display:none'>
	...
	<tr>
		...
		<td>
			...
			echo form_input('sol_disp_crn_ret', set_value('sol_disp_crn_ret', @$sol_disp_crn_ret));
			$id=' id="sol_disp_crn_ret_tipo"';
			echo form_input('sol_disp_crn_ret_tipo', set_value('sol_disp_crn_ret_tipo', @$sol_disp_crn_ret_tipo));
			$id=' id="sol_disp_crn_ret_materia"';
			echo form_input('sol_disp_crn_ret_materia', set_value('sol_disp_crn_ret_materia', @$sol_disp_crn_ret_materia));
			$id=' id="sol_disp_crn_ret_instructor"';
			echo form_input('sol_disp_crn_ret_instructor', set_value('sol_disp_crn_ret_instructor', @$sol_disp_crn_ret_instructor));
			$id=' id="sol_disp_crn_ret_seccion"';
			echo form_input('sol_disp_crn_ret_seccion', set_value('sol_disp_crn_ret_seccion', @$sol_disp_crn_ret_seccion));
			?>		
		</td>
	</tr>
	<tr>
...
<table class='formtable' width="100%" id='crn_sug_2' style='display:none'>
	...
	<tr>
		...
		<td>
			...
			echo form_input('sol_sug_crn_ins', set_value('sol_sug_crn_ins', @$sol_sug_crn_ins));
			$id=' id="sol_sug_crn_ins_tipo"';
			echo form_input('sol_sug_crn_ins_tipo', set_value('sol_sug_crn_ins_tipo', @$sol_sug_crn_ins_tipo));
			$id=' id="sol_sug_crn_ins_materia"';
			echo form_input('sol_sug_crn_ins_materia', set_value('sol_sug_crn_ins_materia', @$sol_sug_crn_ins_materia));
			$id=' id="sol_sug_crn_ins_instructor"';
			echo form_input('sol_sug_crn_ins_instructor', set_value('sol_sug_crn_ins_instructor', @$sol_sug_crn_ins_instructor));
			$id=' id="sol_sug_crn_ins_seccion"';
			echo form_input('sol_sug_crn_ins_seccion', set_value('sol_sug_crn_ins_seccion', @$sol_sug_crn_ins_seccion));
			?>
		</td>
	</tr>
	<tr>
...
<table class='formtable' width="100%" id='crn_sug_1' style='display:none'>
	...
	<tr>
		...
		<td>
			...
			echo form_input('sol_sug_crn_ret', set_value('sol_sug_crn_ret', @$sol_sug_crn_ret));
			$id=' id="sol_sug_crn_ret_tipo"';
			echo form_input('sol_sug_crn_ret_tipo', set_value('sol_sug_crn_ret_tipo', @$sol_sug_crn_ret_tipo));
			$id=' id="sol_sug_crn_ret_materia"';
			echo form_input('sol_sug_crn_ret_materia', set_value('sol_sug_crn_ret_materia', @$sol_sug_crn_ret_materia));
			$id=' id="sol_sug_crn_ret_instructor"';
			echo form_input('sol_sug_crn_ret_instructor', set_value('sol_sug_crn_ret_instructor', @$sol_sug_crn_ret_instructor));
			$id=' id="sol_sug_crn_ret_seccion"';
			echo form_input('sol_sug_crn_ret_seccion', set_value('sol_sug_crn_ret_seccion', @$sol_sug_crn_ret_seccion));
			?>
		</td>
	</tr>
	<tr>
