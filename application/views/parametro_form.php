...
$dperiodo = explode(":=:", @$dperiodo);
?>
	<table class='formtable'>
	<tr>
		<td class="tdlabel">Per&iacute;odo 1:</td>
		<td align="right">
		<?php echo form_input('periodo[]', set_value('periodo',@$periodo[0])); ?><br>
		<b>Descripci&oacute;n:</b> <?php echo form_input('dperiodo[]', set_value('dperiodo',@$dperiodo[0])); ?>
		<?php //echo form_error('descripcion'); ?></td>
	</tr>
	<tr>
		<td class="tdlabel">Per&iacute;odo 2:</td>
		<td align="right">
		<?php echo form_input('periodo[]', set_value('periodo',@$periodo[1])); ?><br>
		<b>Descripci&oacute;n:</b> <?php echo form_input('dperiodo[]', set_value('dperiodo',@$dperiodo[1])); ?>
		<?php //echo form_error('descripcion'); ?></td>
	</tr>
	<tr>
		<td class='tdlabel'>Correo: </td>
		<td align="right"><?php echo form_input('correo_from', set_value('correo_from',$correo_from)); ?>
		<?php //echo form_error('correo_from'); ?></td>
	</tr>
	<tr>
		<td class='tdlabel'>Nombre: </td>
		<td align="right"><?php echo form_input('nombre_from', set_value('nombre_from',$nombre_from)); ?>
		<?php //echo form_error('nombre_from'); ?></td>
	</tr>
	<tr>
		<td class='tdlabel'>Link a página de coordinadores: </td>
		<td align="right"><?php echo form_input('link_coordinadores', set_value('link_coordinadores',$link_coordinadores)); ?>
		<?php //echo form_error('nombre_from'); ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="tdlabel">Fecha Inicial: <input type="text" name="fecha_inicial" id="fecha_inicial" value="<?php echo set_value('fecha_inicial', @$fecha_inicial); ?>" class="datetime" readonly>
		&nbsp;
		<?php
		$js = 'onClick="vaciar_fecha_inicial()"';
		echo form_button('bt_fecha_inicial', 'Vaciar', $js);
		?>
		<td>&nbsp;</td>
	</tr>
	<tr>
