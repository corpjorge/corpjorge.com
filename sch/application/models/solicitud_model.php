...
//echo 'get_count: '.date('Y-m-d h:i:s:u');
//if($qcampo!='')echo 'get_count: '.(string)$this->db->last_query();
		return $resultado;
...
//echo 'get_all: '.date('Y-m-d h:i:s u');
			$res = $this->db->query($query);
//echo 'get_all: '.date('Y-m-d h:i:s u');
//if($qcampo!='')echo 'get_all: '.$query;			
			return $res->result_array();
		}else{
//if($qcampo!='')echo 'get_all: '.$this->db->last_query();
//echo 'get_all: '.date('Y-m-d h:i:s u');
...
//echo 'get_all: '.date('Y-m-d h:i:s u');
	...
	public function get_all_coordinador($page='',$total='',$order='',$campo_order='',$qtype='',$qcampo='',$where=array(),$campo_where='',$arr_prog,$arr_nivel,$qtype2='',$qcampo2='', $fecha_inicial_listado=''){
...
//echo 'get_all_coordinador: '.date('Y-m-d h:i:s:u');
		$res = $this->db->query($query);
//echo 'get_all_coordinador: '.date('Y-m-d h:i:s:u');
//if($qcampo!='')echo 'get_all_coordinador: '.$query;
		return $res->result_array();
