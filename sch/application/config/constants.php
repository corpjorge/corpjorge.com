...
define ('DB_SID', 'nife');
define ('DB_SERVER','daimon.uniandes.edu.co');
define ('DB_PORT', '1521');

/**
 * These constants are used in the Integracion class and describe the oci functions output
 */
define ('DATOS_ESTUDIANTE','CARNET,APELLIDOS,NOMBRES,NIVEL,CODIGO_PROGRAMA,PROGRAMA,DOBLE_PROGRAMA,OPC,OPCION,CRED_INS,PROM_ACUM,SSC');
...
define ('CORREO_PRUEBAS','eamaya@uniandes.edu.co');