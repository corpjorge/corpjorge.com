...
?>
<a class="volver"  href="<?php echo base_url()?>index.php/estado/">Volver</a><br>
...
<?php echo form_open('estado/'.$accion.'/'.$est_id); ?>

	<h1><?php echo $titulo; ?> estado</h1>
	<p>
		<label for="email">Descripci&oacute;n: </label>
		<?php echo form_input('descripcion', set_value('descripcion', $est_descripcion)); ?>
