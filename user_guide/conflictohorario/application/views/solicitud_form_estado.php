...
<div style="text-align:center">
	<a href="<?php echo base_url()?>index.php/solicitud/formaestado/<?php echo $sol_id_anterior; ?>">Anterior</a> | <a href="<?php echo base_url()?>index.php/solicitud/formaestado/<?php echo $sol_id_siguiente; ?>">Siguiente</a><br>
</div>
<?php } ?>
...
<?php if($tipo_entrada=='uno'){?>
	...
	<?php } ?>	
	<?php if(!empty($ids_habilitados)){?>
	 <form name='estadoform' id='estadoform' action='<?php echo base_url()?>index.php/solicitud/estado' method='POST'>
