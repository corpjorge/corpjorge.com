...
$(document).ready(function() {
    ...
    var myFlex = $("#flex1").flexigrid({
      ...
      dataType: 'json',
      colModel : [
	{display: 'Programa', name : 'dep_id', width : 40, sortable : false, align: 'left'},
	{display: 'Estado', name : 'est_descripcion', width : 300, sortable : false, align: 'left'},
	{display: 'TOTAL', name : 'total', width : 40, sortable : false, align: 'left'}	
      ],
      buttons : [
	...
	{separator: true}
      ...
      /*searchitems : [
	{display: 'Programa', name : 'dep_id', width : 100, sortable : true, align: 'left'},
	{display: 'Estado', name : 'est_descripcion', width : 100, sortable : true, align: 'left'},
	{display: 'TOTAL', name : 'total', width :100, sortable : true, align: 'left'}	
      ],*/
      otro: '<?php echo $programa_id;?>***<?php echo $estado_id;?>***<?php echo $fecha_ini;?>***<?php echo $fecha_fin;?>***<?php echo $reporte;?>',
      sortname: "dep_id",      
      sortorder: "asc",
      usepager: true,
