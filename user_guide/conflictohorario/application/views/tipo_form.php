...
?>
<a class="volver" href="<?php echo base_url()?>index.php/tipo/">Volver</a><br>
...
<?php echo form_open('tipo/'.$accion.'/'.$tip_id); ?>
	<h1><?php echo $titulo; ?> tipo</h1>
	<p>
		<label for="email">Descripci&oacute;n: </label>
		<?php echo form_input('descripcion', set_value('descripcion', $tip_descripcion)); ?>
